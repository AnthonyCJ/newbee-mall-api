...
public class NewBeeAdminGoodsInfoAPI {
     ...
     * 添加
     *
     * @param goodsAddParam 新增商品所需信息，包括商品id、商品名称等
     * @param adminUser 管理员用户身份令牌
     * @return 操作结果
     *
     */
     ...
     * 修改
     *
     * @param goodsEditParam 修改的商品信息，包括商品id、新的商品名称等
     * @param adminUser 管理员用户身份令牌
     * @return 操作结果
     *
     */
     ...
     * 批量修改销售状态
     *
     * @param batchIdParam 批量修改销售状态的商品id列表
     * @param adminUser 管理员用户身份令牌
     * @return 操作结果
     */
